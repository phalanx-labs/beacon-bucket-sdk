...
func TestNormalUpload_Upload(t *testing.T) {
	...
	client.SetHeader("app-access-id", "341596753619002368")
	client.SetHeader("app-secret-key", "cs_e49d93365f7b4409bc051e698e17b8ae")
...
func TestNewClient(t *testing.T) {
	...
	if client.normalUpload == nil {
		t.Fatal("normalUpload service should not be nil")
	}
}
